...
// Text
$_['text_option']      		= 'Выберите вариант';
$_['text_category_selected']= 'Выбрана категория';
$_['text_material_add']  	= 'Добавить материал';
$_['text_material_remove']  = 'Удалить материал';
$_['text_tag_add']  		= 'Добавить тег';
$_['text_tag_remove']  		= 'Удалить тег';
$_['text_created']  		= 'Ваш список создан';
$_['text_listing_id']  		= 'Список ID';
$_['text_img_upload']  		= 'Загрузка изображения';
...
$_['entry_sub_category']    = 'Подкатегория';
$_['entry_sub_sub_category']= 'Sub-sub category';
$_['entry_who_made']		= 'Кто это сделал?';
$_['entry_when_made']		= 'Когда это было сделано?';
$_['entry_recipient']		= 'Для кого это?';
$_['entry_occasion']		= 'Что это за событие?';
$_['entry_is_supply']		= 'Это предложение?';
