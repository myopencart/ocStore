    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="row extension-info">
          ...
          <div class="col-sm-4">
            <div id="buy" class="well"><?php if ($license == 1) { ?>
              <a target="_blank" href="<?php echo $extension_url; ?>?utm_source=ocstore_marketplace_old" id="button-buy" class="btn btn-success btn-lg btn-block"><?php echo $button_purchase; ?></a>
              <?php } ?>
