  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-shoputils-payeer" class="btn btn-primary"><i class="fa fa-save"></i> <?php echo $button_save; ?></button>
        <a href="<?php echo $cancel; ?>" class="btn btn-default"><i class="fa fa-reply"></i> <?php echo $button_cancel; ?></a></div>
      <h1><img src="view/image/payment/shoputils_payeer.png"> <?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-shoputils-payeer" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_geo_zone_id" id="input-geo-zone" class="form-control">
                    <option value="0"><?php echo $text_all_zones; ?></option>
                    <?php foreach ($geo_zones as $geo_zone) { ?>
                    <?php if ($geo_zone['geo_zone_id'] == $shoputils_payeer_geo_zone_id) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_status" id="input-status" class="form-control">
                    <?php if ($shoputils_payeer_status) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="shoputils_payeer_sort_order" value="<?php echo $shoputils_payeer_sort_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_hide_mode" id="input-hide_mode" class="form-control">
                    <?php if ($shoputils_payeer_hide_mode) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="shoputils_payeer_minimal_order" value="<?php echo $shoputils_payeer_minimal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="shoputils_payeer_maximal_order" value="<?php echo $shoputils_payeer_maximal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_order_confirm_status_id" id="input-order-confirm-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $shoputils_payeer_order_confirm_status_id) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_order_status_id" id="input-order-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $shoputils_payeer_order_status_id) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_order_fail_status_id" id="input-order-fail-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $shoputils_payeer_order_fail_status_id) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_laterpay_mode) { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_mode" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_mode" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_laterpay_mode) { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_mode" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_mode" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group" id="laterpay-mode-tr" style="display: none;">
                ...
                <div class="col-sm-10">
                  <select name="shoputils_payeer_order_later_status_id" id="input-order-later-status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if ($order_status['order_status_id'] == $shoputils_payeer_order_later_status_id) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][title]"
                           value="<?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['title'])
                                  ? $shoputils_payeer_langdata[$language['language_id']]['title'] : $title_default[0]; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][instruction]" rows="5"
                              placeholder="<?php echo $placeholder_instruction; ?>"
                              name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][instruction]"
                              class="form-control"><?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['instruction'])
                                                   ? $shoputils_payeer_langdata[$language['language_id']]['instruction'] : ''; ?></textarea>
                  </div>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_laterpay_button_lk) { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_button_lk" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_button_lk" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_laterpay_button_lk) { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_button_lk" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_laterpay_button_lk" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][button_confirm]"
                           value="<?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['button_confirm'])
                                  ? $shoputils_payeer_langdata[$language['language_id']]['button_confirm'] : $sample_button_confirm; ?>"
            ...
            <div class="tab-pane" id="tab-emails">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_notify_customer_success) { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_success" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_success" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_notify_customer_success) { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_success" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_success" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group required" id="mail-customer-success-tr" style="display: none;">
                ...
                <div class="col-sm-8">
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_subject]"
                           value="<?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['mail_customer_success_subject'])
                                  ? $shoputils_payeer_langdata[$language['language_id']]['mail_customer_success_subject'] : $sample_mail_customer_success_subject; ?>"
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_success_content]" rows="5"
                              id="mail-customer-success-content<?php echo $language['language_id']; ?>"
                              placeholder="<?php echo $entry_mail_customer_success_content; ?>"
                              class="form-control"><?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['mail_customer_success_content'])
                                                   ? $shoputils_payeer_langdata[$language['language_id']]['mail_customer_success_content'] : $sample_mail_customer_success_content; ?></textarea>
                  </div>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_notify_customer_fail) { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_fail" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_fail" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_notify_customer_fail) { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_fail" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_customer_fail" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group required" id="mail-customer-fail-tr" style="display: none;">
                ...
                <div class="col-sm-8">
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <input type="text" name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_subject]"
                           value="<?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['mail_customer_fail_subject'])
                                  ? $shoputils_payeer_langdata[$language['language_id']]['mail_customer_fail_subject'] : $sample_mail_customer_fail_subject; ?>"
                  ...
                  <div class="input-group">
                    <?php $language_image = version_compare(VERSION, '2.2.0.0', '<') ? 'view/image/flags/' . $language['image'] : sprintf('language/%1$s/%1$s.png', $language['code']); ?>
                    <span class="input-group-addon"><img src="<?php echo $language_image; ?>" title="<?php echo $language['name']; ?>" /></span>
                    <textarea name="shoputils_payeer_langdata[<?php echo $language['language_id']; ?>][mail_customer_fail_content]" rows="5"
                              id="mail-customer-fail-content<?php echo $language['language_id']; ?>"
                              placeholder="<?php echo $entry_mail_customer_fail_content; ?>"
                              class="form-control"><?php echo !empty($shoputils_payeer_langdata[$language['language_id']]['mail_customer_fail_content'])
                                                   ? $shoputils_payeer_langdata[$language['language_id']]['mail_customer_fail_content'] : $sample_mail_customer_fail_content; ?></textarea>
                  </div>
                  <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_notify_admin_success) { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_success" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_success" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_notify_admin_success) { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_success" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_success" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group required" id="mail-admin-success-tr" style="display: none;">
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" name="shoputils_payeer_mail_admin_success_subject" id="input-mail-admin-success-subject"
                         value="<?php echo !empty($shoputils_payeer_mail_admin_success_subject)
                                ? $shoputils_payeer_mail_admin_success_subject : $sample_mail_admin_success_subject; ?>"
                  ...
                  <textarea name="shoputils_payeer_mail_admin_success_content" rows="5"
                            id="input-mail-admin-success-content"
                            placeholder="<?php echo $entry_mail_admin_success_content; ?>"
                            class="form-control"><?php echo !empty($shoputils_payeer_mail_admin_success_content)
                                                 ? $shoputils_payeer_mail_admin_success_content : $sample_mail_admin_success_content; ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <label class="radio-inline">
                    <?php if ($shoputils_payeer_notify_admin_fail) { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_fail" value="1" checked="checked" />
                    <?php echo $text_yes; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_fail" value="1" />
                    <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$shoputils_payeer_notify_admin_fail) { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_fail" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="shoputils_payeer_notify_admin_fail" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
              ...
              <div class="form-group required" id="mail-admin-fail-tr" style="display: none;">
                ...
                <div class="col-sm-8">
                  ...
                  <input type="text" name="shoputils_payeer_mail_admin_fail_subject" id="input-mail-admin-fail-subject"
                         value="<?php echo !empty($shoputils_payeer_mail_admin_fail_subject)
                                ? $shoputils_payeer_mail_admin_fail_subject : $sample_mail_admin_fail_subject; ?>"
                  ...
                  <textarea name="shoputils_payeer_mail_admin_fail_content" rows="5"
                            id="input-mail-admin-fail-content"
                            placeholder="<?php echo $entry_mail_admin_fail_content; ?>"
                            class="form-control"><?php echo !empty($shoputils_payeer_mail_admin_fail_content)
                                                 ? $shoputils_payeer_mail_admin_fail_content : $sample_mail_admin_fail_content; ?></textarea>
            ...
            <div class="tab-pane" id="tab-settings">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="shoputils_payeer_shop_id" value="<?php echo $shoputils_payeer_shop_id; ?>"
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="shoputils_payeer_sign_hash" value="<?php echo $shoputils_payeer_sign_hash; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } else { ?>
                    <select name="shoputils_payeer_currency" id="input-currency" class="form-control">
                      <?php foreach ($currencies as $key => $value) { ?>
                      <?php if ($key == $shoputils_payeer_currency) { ?>
            ...
            <div class="tab-pane" id="tab-log">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="hidden" name="shoputils_payeer_log_filename" value="<?php echo $log_filename ?>" />
                  <input type="hidden" name="shoputils_payeer_version" value="<?php echo $version ?>" />
                  <select name="shoputils_payeer_log" id="input-log" class="form-control">
                    <?php foreach ($logs as $key => $value) { ?>
                    <?php if ($key == $shoputils_payeer_log) { ?>
                    <option value="<?php echo $key; ?>"
                            selected="selected"><?php echo $value; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $key; ?>"><?php echo $value; ?></option>
...
<script type="text/javascript"><!--
  ...
  $(document).ready(function(){
    $('input:radio[name^="shoputils_payeer_laterpay_mode"]:checked').each(function(indx){
      changeLaterpayMode($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_customer_success"]:checked').each(function(indx){
      changeNotifyCustomerSuccess($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_customer_fail"]:checked').each(function(indx){
      changeNotifyCustomerFail($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_admin_success"]:checked').each(function(indx){
      changeNotifyAdminSuccess($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_admin_fail"]:checked').each(function(indx){
      changeNotifyAdminFail($(this).val());
    });
  });
    $('input:radio[name^="shoputils_payeer_laterpay_mode"]').change(function(){
      changeLaterpayMode($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_customer_success"]').change(function(){
      changeNotifyCustomerSuccess($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_customer_fail"]').change(function(){
      changeNotifyCustomerFail($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_admin_success"]').change(function(){
      changeNotifyAdminSuccess($(this).val());
    });
    $('input:radio[name^="shoputils_payeer_notify_admin_fail"]').change(function(){
      changeNotifyAdminFail($(this).val());
    });
