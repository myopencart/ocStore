          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_merch_r" value="<?php echo $webmoney_wmy_merch_r; ?>"
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_secret_key" value="<?php echo $webmoney_wmy_secret_key; ?>"
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_secret_key_x20" value="<?php echo $webmoney_wmy_secret_key_x20; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmy_result_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmy_success_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <span class="form-control" style="height:auto;"><?php echo $webmoney_wmy_fail_url; ?></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_order_confirm_status_id" id="input-order_confirm_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
                    <?php if ($order_status['order_status_id'] == $webmoney_wmy_order_confirm_status_id) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_order_status_id" id="input-order_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
                    <?php if ($order_status['order_status_id'] == $webmoney_wmy_order_status_id) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_order_fail_status_id" id="input-order_fail_status" class="form-control">
                    <?php foreach ($order_statuses as $order_status) { ?>
                    <?php if (!isset($order_status['order_status_id'])) continue; ?>
                    <?php if ($order_status['order_status_id'] == $webmoney_wmy_order_fail_status_id) { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>" selected="selected"><?php echo $order_status['name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $order_status['order_status_id']; ?>"><?php echo $order_status['name']; ?></option>
                    <?php } ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_hide_mode" id="input-hide_mode" class="form-control">
                    <?php if ($webmoney_wmy_hide_mode) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_minimal_order" value="<?php echo $webmoney_wmy_minimal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_maximal_order" value="<?php echo $webmoney_wmy_maximal_order; ?>"
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_geo_zone_id" id="input-geo_zone" class="form-control">
                    <option value="0"><?php echo $text_all_zones; ?></option>
                    <?php foreach ($geo_zones as $geo_zone) { ?>
                    <?php if ($geo_zone['geo_zone_id'] == $webmoney_wmy_geo_zone_id) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="webmoney_wmy_status" id="input-status" class="form-control">
                    <?php if ($webmoney_wmy_status) { ?>
                    <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                    <option value="0"><?php echo $text_disabled; ?></option>
                    <?php } else { ?>
                    <option value="1"><?php echo $text_enabled; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" name="webmoney_wmy_sort_order" value="<?php echo $webmoney_wmy_sort_order; ?>"
            ...
            <div class="tab-pane" id="tab-log">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="hidden" name="webmoney_wmy_log_filename" value="<?php echo $log_filename ?>" />
                  <select name="webmoney_wmy_log" id="input-log" class="form-control">
                    <?php foreach ($logs as $key => $value) { ?>
                    <?php if ($key == $webmoney_wmy_log) { ?>
