      ...
      <div class="panel-body">
        <div class="well">
          <div class="input-group" id="extension-filter">
            <input type="text" name="filter_search" value="<?php echo $filter_search; ?>" placeholder="<?php echo $text_search; ?>" id="input-name" class="form-control" />
            <div class="input-group-btn"> <?php foreach ($categories as $category) { ?>
              ...
              <input type="hidden" name="filter_category" value="<?php echo $filter_category; ?>" class="form-control" />
