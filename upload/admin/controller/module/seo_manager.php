...
class ControllerModuleSeoManager extends Controller {
    ...
    protected function getForm() {
        ...
        $data['sort_query'] = $this->url->link('module/seo_manager', 'token=' . $this->session->data['token'] . '&sort=query' . $url, 'SSL');
        $data['sort_keyword'] = $this->url->link('module/seo_manager', 'token=' . $this->session->data['token'] . '&sort=keyword' . $url, 'SSL');
    ...
    protected function validatePermission() {
        return $this->user->hasPermission('modify', 'module/seo_manager');
    }
}