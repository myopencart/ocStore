<?php
// Heading
$_['heading_title']          = 'Параметры сервера';

// Text
$_['text_step_2']            = 'Проверьте что Ваш сервер настроен правильно';
$_['text_install_php']       = '1. Убедитесь что настройки PHP соответствуют требованиям, указанным ниже.';
$_['text_install_extension'] = '2. Убедитесь, что на сервере устанавлены перечисленные ниже библиотеки.';
$_['text_install_db']        = '3. Убедитесь, что у Вас есть по крайней мере один доступный драйвер базы данных.';
$_['text_install_file']      = '4. Убедитесь что Вы переименовали файлы указанные ниже.';
$_['text_install_directory'] = '5. Убедитесь, что Вы установили правильные разрешения для перечисленных каталогов.';
$_['text_current']           = 'Текущие Настройки';
$_['text_required']          = 'Необходимые настройки';
$_['text_extension']         = 'Дополнительные библиотеки';
