...
$_['text_success']       = 'Настройки SagePay изменены!';
...
// Error
$_['error_permission']   = 'Вы не имеете полномочий для изменения настроек SagePay';
$_['error_vendor']       = 'Необходимо указать код продавца!';
